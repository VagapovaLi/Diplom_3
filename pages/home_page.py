...
class HomePage(BasePage):
    ...
    def click_cross_order(self):
        self.move_to_element_and_click(HomePageLocators.BUTTON_PLACE_ORDER)
    ...
    def add_filling_to_order(self):
        self.wait_element_to_be_clickable(HomePageLocators.IMG_BUN_INGREDIENT)
        self.drag_and_drop_to_element(HomePageLocators.IMG_BUN_INGREDIENT, HomePageLocators.CONSTRUCTOR_BASKET)


    @allure.step('Добавить соус')
    def add_filling_to_order_sauce(self):
        self.wait_element_to_be_clickable(HomePageLocators.IMG_SAUCE_INGREDIENT)
        self.drag_and_drop_to_element(HomePageLocators.IMG_SAUCE_INGREDIENT, HomePageLocators.CONSTRUCTOR_BASKET)


    @allure.step('Сделать заказ')
    def make_order(self):
        self.add_filling_to_order()
        self.click_cross_order()
        self.get_order_id()
